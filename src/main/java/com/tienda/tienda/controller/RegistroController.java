...
public class RegistroController {
  ...
  public String activar(Model model,@PathVariable(value="usuario")String usuario,@PathVariable(value="id")String id,@RequestParam("imagenFile")MultipartFile imagenFile ){
