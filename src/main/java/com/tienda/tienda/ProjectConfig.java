    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(
                        ...
                        "/reportes/**","/pruebas/**"
                ).hasRole("ADMIN") //todas las vistas que estan en el apartado de arriba las puede ver el ADMIN
                .requestMatchers(
                        "/producto/listado",
                        "/categoria/listado",
                        "/usuario/listado"
                ).hasAnyRole("ADMIN", "VENDEDOR") // todas las vistas que estan en el apartado de arriba las pueden ver o un ADMIN o un VENDEDOR
